			...
			Dependencies: manifest.Dependencies{
				ControlPlane: map[string]manifest.Dependency{
					"etcd": manifest.Dependency{
						...
						PrebakePath:  "/opt/kubekit/kubekit-control-plane/quay.io/coreos/etcd-v3.3.9.tar.xz",
				...
				Core: map[string]manifest.Dependency{
					"hyperkube": manifest.Dependency{
						...
						PrebakePath:  "/opt/kubekit/kubekit-core/quay.io/coreos/hyperkube-v1.9.1_coreos.0.tar.xz",
					...
					"healthz": manifest.Dependency{
						...
						PrebakePath:  "/opt/kubekit/kubekit-core/gcr.io/google_containers/exechealthz-amd64-1.2.tar.xz",
			...
			Dependencies: manifest.Dependencies{
				Core: map[string]manifest.Dependency{
					"dnsmasq-metrics": manifest.Dependency{
						...
						PrebakePath:  "/opt/kubekit/kubekit-core/gcr.io/google_containers/dnsmasq-metrics-amd64-1.0.1.tar.xz",
					...
					"pause": manifest.Dependency{
						...
						PrebakePath:  "/opt/kubekit/kubekit-core/gcr.io/google_containers/pause-1.0.tar.xz",
    ...
    dependencies:
      core:
        dnsmasq-metrics:
          ...
          name: dnsmasq-metrics
          src: gcr.io/google_containers/dnsmasq-metrics-amd64:1.0.1
          prebake-path: /opt/kubekit/kubekit-core/gcr.io/google_containers/dnsmasq-metrics-amd64-1.0.1.tar.xz
          checksum: 6453b3ee4f5455657133ada25c858ba695d2f90db69f3e8e69b3d9a2f6392a66
        ...
        pause:
          ...
          name: pause
          src: gcr.io/google_containers/pause
          prebake-path: /opt/kubekit/kubekit-core/gcr.io/google_containers/pause-1.0.tar.xz
          checksum: a78c2d6208eff9b672de43f880093100050983047b7b0afe0217d3656e1b0d5f
          checksum_type: sha256
          license_url: ""
  1.1.1:
    ...
    dependencies:
      control-plane:
        etcd:
          ...
          name: etcd
          src: quay.io/coreos/etcd:v3.3.9
          prebake-path: /opt/kubekit/kubekit-control-plane/quay.io/coreos/etcd-v3.3.9.tar.xz
          checksum: ea49a3d44a50a50770bff84eab87bac2542c7171254c4d84c609b8c66aefc211
          checksum_type: sha256
      ...
      core:
        healthz:
          ...
          name: exechealthz
          src: gcr.io/google_containers/exechealthz-amd64:1.2
          prebake-path: /opt/kubekit/kubekit-core/gcr.io/google_containers/exechealthz-amd64-1.2.tar.xz
          checksum: 503e158c3f65ed7399f54010571c7c977ade7fe59010695f48d9650d83488c0a
          checksum_type: sha256
          license_url: ""
        hyperkube:
          ...
          name: hyperkube
          src: quay.io/coreos/hyperkube:v1.9.1_coreos.0
          prebake-path: /opt/kubekit/kubekit-core/quay.io/coreos/hyperkube-v1.9.1_coreos.0.tar.xz
          checksum: 9ed9046760a30d1cafbf9c7dec431428ce4838ddde62eefd7fafb268aa902e2d
          checksum_type: sha256
          license_url: ""
`)
