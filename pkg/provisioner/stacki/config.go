...
var defaultConfig = Config{
	...
	APIAddress:             "",
	KubeAPISSLPort:         6558,
	KubeVIPAPISSLPort:      8444,
	KubeVirtualIPApi:       requiredValue + "39.80.0.100",
	PublicVirtualIP:        requiredValue + "39.80.0.200",
...
var defaultMasterNodePool = NodePool{
	...
	Nodes: []Node{
		Node{
			...
			PublicDNS:  requiredValue + "master1.stacki.test",
